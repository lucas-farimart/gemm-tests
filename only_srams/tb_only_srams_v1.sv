...
// com dados aleatorios INT8 e arquivos HEX de 32 bits
//---------------------------------------------------------------------
...
module tb_only_srams_v1;
    ...
    localparam X_SIZE     = 12;
    localparam Y_SIZE     = 12;
    localparam LATENCY    = 2;

    localparam int NUM_TESTS = 10;

    string X_HEX_FILE = "data/x.hex";
    string W_HEX_FILE = "data/w.hex";
    ...
    task write_X_hex();
        ...
        for (int i=0; i<(X_SIZE+3)/4; i++) $fdisplay(fd, "%08h", X_MEM[i]);
